...
namespace MathServiceTestApp1.MathService1 {
    ...
    public interface IMathService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/Sin", ReplyAction="http://tempuri.org/IMathService/SinResponse")]
        int Sin(int num1, int num2);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/Sin", ReplyAction="http://tempuri.org/IMathService/SinResponse")]
        System.Threading.Tasks.Task<int> SinAsync(int num1, int num2);
    }
    ...
    public partial class MathServiceClient : System.ServiceModel.ClientBase<MathServiceTestApp1.MathService1.IMathService>, MathServiceTestApp1.MathService1.IMathService {
        ...
        public int Sin(int num1, int num2) {
            return base.Channel.Sin(num1, num2);
        }
        
        public System.Threading.Tasks.Task<int> SinAsync(int num1, int num2) {
            return base.Channel.SinAsync(num1, num2);
        }
    }
}
